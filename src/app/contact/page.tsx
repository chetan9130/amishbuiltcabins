          ...
          <div className="lg:col-span-5 space-y-6">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-[-2px] text-[#101114] leading-[0.95]">
                Let&apos;s Build <br />
                <span className="text-[#e20b16]">Something Great.</span>
              </h1>
            ...
            <div className="space-y-3 pt-2 border-t border-[#e7e9ee]">
              ...
              <div className="card p-4 flex items-start gap-3.5 bg-white">
                <div className="p-2.5 rounded-[9px] bg-[#e20b16]/10 text-[#e20b16] shrink-0">
        ...
        <div className="mt-20 pt-12 border-t border-[#e7e9ee]" id="faq">
          <div className="max-w-3xl mb-8">
            <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-[#e20b16] mb-2">
              <HelpCircle className="w-3.5 h-3.5 text-[#e20b16]" />
