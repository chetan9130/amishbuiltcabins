            ...
            >
              <div>
                <div className="relative aspect-[16/10] w-full overflow-hidden bg-gray-100">
                  ...
                  />
                  <div className="absolute top-3 left-3 bg-[#e20b16] text-white text-[10px] font-extrabold uppercase px-2.5 py-1 rounded-[6px] shadow-sm">
                    {article.category}
                  </div>
                </div>
                ...
                <div className="p-5 sm:p-6 space-y-3">
                  ...
                  <h2 className="text-base sm:text-lg font-black text-[#101114] group-hover:text-[#e20b16] transition-colors leading-snug">
                    {article.title}
                  </h2>
