...
export default function AdminPagesPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#e7e9ee] pb-5">
        <div>
          ...
          <p className="text-xs sm:text-sm text-[#6b7280] mt-1 font-medium">
            Create, edit, and organize core website pages and their dynamic modular sections.
          </p>
        </div>
      ...
      <div className="bg-white p-4 rounded-[18px] border border-[#e7e9ee] shadow-[0_12px_35px_rgba(16,24,40,0.04)] flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="bg-[#f6f7f9] border-b border-[#e7e9ee] text-[#101114] font-bold uppercase tracking-wider text-[11px]">
                  ...
                  <th className="py-4 px-4">Sections</th>
              ...
              <tbody className="divide-y divide-[#e7e9ee]">
                {pages.map((page) => {
                  ...
                  return (
                    <tr key={pageId} className="hover:bg-[#f6f7f9]/70 transition-colors">
                      <td className="py-4 px-4 font-bold text-[#101114]">
                      ...
                      <td className="py-4 px-4 text-[#6b7280] text-[11px] font-medium">
